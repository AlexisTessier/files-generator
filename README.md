...
[![version](https://img.shields.io/badge/version-0.0.1-blue.svg)](https://github.com/AlexisTessier/files-generator#readme)
...
Generate files from different kinds of sources

**Parameters**

-   `$0` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)**  (optional, default `{}`)
    -   `$0.writeFile`   (optional, default `defaultWriteFile`)
    -   `$0.encoding`   (optional, default `defaultEncoding`)
    -   `$0.cwd`   (optional, default `process.cwd()`)
