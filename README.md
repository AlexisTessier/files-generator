...
![Branch : tests-suite-refactoring](https://img.shields.io/badge/Branch-tests-suite-refactoring-blue.svg)
...
[![Build Status](https://travis-ci.org/AlexisTessier/files-generator.svg?branch=tests-suite-refactoring)](https://travis-ci.org/AlexisTessier/files-generator)
[![Coverage Status](https://coveralls.io/repos/AlexisTessier/files-generator/badge.svg?branch=tests-suite-refactoring&service=github)](https://coveralls.io/github/AlexisTessier/files-generator?branch=tests-suite-refactoring)
